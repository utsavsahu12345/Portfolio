...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 left-10 w-20 h-20 rounded-full bg-primary/50 animate-float" />
      <div
        className="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-accent/50 animate-float"
        style={{ animationDelay: "2s" }}
      />
      <div
        className="absolute top-1/2 left-20 w-16 h-16 rounded-full bg-primary/50 animate-float"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-10">
          ...
          >
            <img
              src={`${import.meta.env.BASE_URL}utsav.jpg`}
              alt="Utsav Sahu"
              className="rounded-full w-64 h-64 object-cover border-4 border-white shadow-xl bg-white/20"
            />
          </motion.div>
